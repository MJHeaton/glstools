...
The goal of glsTools is to make analysis of correlated data easier by providing tools to *correctly* predict and standardize *decorrelated* residuals from `gls` objects in R. Additional functionality to calculate Moran Basis functions is also provided.
